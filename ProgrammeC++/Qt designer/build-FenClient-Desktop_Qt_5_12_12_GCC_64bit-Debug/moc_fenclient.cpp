...
void FenClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FenClient *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject FenClient::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_FenClient.data,
    qt_meta_data_FenClient,
    qt_static_metacall,
    nullptr,
    nullptr
} };
